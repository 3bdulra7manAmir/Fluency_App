...
class HiveDB
{
  ...
  static String get getBoxName => teachersDetailsbox;

  static const String teachersDetailsbox = "Teachers_Details_Box";

  Future<void> saveTeacher(TeachersInfoDB teacherInfo) async {
    try {
      var box = await Hive.openBox<TeachersInfoDB>(teachersDetailsbox);
