      ...
      containerChild: Row(
        ...
        [
          Column(
            ...
            children:
            [
              Text("Free Account?", style: Styles.textStyle10.copyWith(color: AppColors.kLoginFormBoxDecorationColor, 
          ...
          SvgPicture.asset('assets/images/svg/Teacher_View_Yellow_Arrow.svg'),
        ],
      ),
    );
  }
