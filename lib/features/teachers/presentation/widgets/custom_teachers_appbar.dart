        ...
        children: [
          Row(
            ...
            [
              ...
              GestureDetector(onTap: () {}, child: const CustomFreeAccountContainer()),
              7.5.horizontalSpace,

              GestureDetector(onTap: () {}, child: const CustomTeachersBillContainer()),
            ],
          ),
          ...
          GestureDetector(
              onTap: () {},
              child: SvgPicture.asset(AppIMGs().kFluencyTeacherViewDownWordArrowsSVG,)),
        ],
      ),
    );
  }
